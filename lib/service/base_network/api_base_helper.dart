...
class ApiBaseHelper {
  ...
  getToken() async {
    await UserSession.getTokenPreference().then((value) {
      this._header = {"Authorization" :"bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BrgW3F7DeFVeL1migLNwrXhwoRnfNYbuy99_KIt4Yp8"};//{"Authorization": "$value"};
    }).catchError((error) {
      return "";
    });
  }
